...
import { withQuery, hasProtocol, isScriptProtocol, joinURL } from "ufo";
import "devalue";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CaArgi4Q.js").then((m) => m.default || m)
  },
  {
    name: "MyFooter",
    path: "/MyFooter",
    component: () => import("./_nuxt/MyFooter-BdCCPE4W.js").then((m) => m.default || m)
  },
  {
    name: "MyHeader",
    path: "/MyHeader",
    component: () => import("./_nuxt/MyHeader-BPos5U7i.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-C53avcjX.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-C9bPTPhK.js").then((r) => r.default || r));
